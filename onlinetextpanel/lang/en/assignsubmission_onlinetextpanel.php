...
/**
 * Strings for component 'assignsubmission_onlinetextpanel', language 'en'
 *
...
$string['allowonlinetextpanelsubmissions'] = 'Enabled';
$string['default'] = 'Enabled by default';
$string['default_help'] = 'If set, this submission method will be enabled by default for all new assignments.';
$string['enabled'] = 'Online text panel';
$string['enabled_help'] = 'If enabled, students are able to type rich text directly into an editor field for their submission with an enhanced UI.';
$string['eventassessableuploaded'] = 'An online text has been uploaded.';
$string['nosubmission'] = 'Nothing has been submitted for this assignment';
$string['onlinetextpanel'] = 'Online text panel';
$string['onlinetextpanelfilename'] = 'onlinetextpanel.html';
$string['onlinetextpanelsubmission'] = 'Allow online text submission';
$string['numwords'] = '({$a} words)';
$string['pluginname'] = 'Online text panel submissions';
