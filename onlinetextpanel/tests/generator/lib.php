 ...
 */
class assignsubmission_onlinetextpanel_generator extends assignsubmission_subplugin_generator {
    /**
    ...
    public function add_submission_data(stdClass $submission, assign $assign, array $data): void {
        if (array_key_exists('onlinetextpanel', $data)) {
            $submission->onlinetextpanel_editor = [
                'itemid' => file_get_unused_draft_itemid(),
                'text' => $data['onlinetextpanel'],
                'format' => FORMAT_HTML,
            ];
        }
    }
