...
/**
 * Tests for mod/assign/submission/onlinetextpanel/locallib.php
 *
 * @package   assignsubmission_onlinetextpanel
 * @copyright 2016 Cameron Ball
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace assignsubmission_onlinetextpanel;
...
/**
 * Unit tests for mod/assign/submission/onlinetextpanel/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class locallib_test extends \advanced_testcase {
    ...
    public function test_submission_is_empty($submissiontext, $expected) {
        ...
        $assign = $this->create_instance($course, [
                'assignsubmission_onlinetextpanel_enabled' => true,
            ]);
