...
/**
 * Unit tests for assignsubmission_onlinetextpanel.
 *
...
/**
 * Unit tests for mod/assign/submission/onlinetextpanel/classes/privacy/
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider_test extends \mod_assign\privacy\provider_test {
    ...
    protected function create_online_submission($assign, $student, $text) {
        ...
        $data = new \stdClass();
        $data->onlinetextpanel_editor = array(
        ...
        $plugin = $assign->get_submission_plugin_by_type('onlinetextpanel');
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('assignsubmission_onlinetextpanel');
        $collection = \assignsubmission_onlinetextpanel\privacy\provider::get_metadata($collection);
    ...
    public function test_export_submission_user_data() {
        ...
        \assignsubmission_onlinetextpanel\privacy\provider::export_submission_user_data($exportdata);
        $this->assertEquals($submissiontext, $writer->get_data(['Attempt 1',
                get_string('privacy:path', 'assignsubmission_onlinetextpanel')])->text);
    }
    ...
    public function test_delete_submission_for_context() {
        ...
        \assignsubmission_onlinetextpanel\privacy\provider::delete_submission_for_context($requestdata);
    ...
    public function test_delete_submission_for_userid() {
        ...
        \assignsubmission_onlinetextpanel\privacy\provider::delete_submission_for_userid($requestdata);
    ...
    public function test_delete_submissions() {
        ...
        $data = $DB->get_records('assignsubmission_onlinetextpanel', ['assignment' => $assign1->get_instance()->id]);
        ...
        \assignsubmission_onlinetextpanel\privacy\provider::delete_submissions($requestdata);
        ...
        $data = $DB->get_records('assignsubmission_onlinetextpanel', ['assignment' => $assign2->get_instance()->id]);
