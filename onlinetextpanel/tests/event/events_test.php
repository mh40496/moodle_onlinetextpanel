...
class events_test extends \advanced_testcase {
    ...
    public function test_assessable_uploaded() {
        ...
        $event = reset($events);
        $this->assertInstanceOf('\assignsubmission_onlinetextpanel\event\assessable_uploaded', $event);
    ...
    /**
     * Test that the submission_created event is fired when an onlinetextpanel submission is saved.
     */
    public function test_submission_created() {
        ...
        $this->assertCount(2, $events);
        $event = $events[1];
        $this->assertInstanceOf('\assignsubmission_onlinetextpanel\event\submission_created', $event);
        $this->assertEquals($context->id, $event->contextid);
    ...
    /**
     * Test that the submission_updated event is fired when an onlinetextpanel
    ...
    public function test_submission_updated() {
        ...
        $this->assertCount(2, $events);
        $event = $events[1];
        $this->assertInstanceOf('\assignsubmission_onlinetextpanel\event\submission_updated', $event);
        $this->assertEquals($context->id, $event->contextid);
        $this->assertEquals($course->id, $event->courseid);
        $this->assertEquals($submission->id, $event->other['submissionid']);
        $this->assertEquals($submission->attemptnumber, $event->other['submissionattempt']);
